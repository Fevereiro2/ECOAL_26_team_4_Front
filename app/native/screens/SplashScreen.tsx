...
export function SplashScreen({ colors }: SplashScreenProps) {
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <View style={{ flex: 1, alignItems: "center", justifyContent: "center", padding: 24 }}>
        <Image
          ...
          style={{ width: 98, height: 98, borderRadius: 24, marginBottom: 16, borderWidth: 2, borderColor: colors.primary }}
        />

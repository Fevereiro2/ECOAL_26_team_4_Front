...
import type { AppColors, AppUser, Role } from "../types";
...
export function AuthScreen({
  ...
  const openPopup = (nextMode: "login" | "register") => {
    setMode(nextMode);
    setErrors({});
    setFormError(null);
    setIsPopupOpen(true);
  ...
  const handleSubmit = () => {
    ...
    const error = onRegister(name, email, password);
    if (error) setFormError(error);
  };
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      <ImageBackground
        source={require("../../../assets/images/prototypes/auth-hero.png")}
        style={{ flex: 1 }}
          ...
          <View style={{ paddingHorizontal: 20, paddingBottom: 22 }}>
            <View style={{ flexDirection: "row", gap: 18 }}>
              <Pressable
                ...
                style={{ flex: 1, backgroundColor: colors.primary, borderRadius: 999, paddingVertical: 14 }}
              >
          ...
          >
            ...
            >
              <TextInput
                ...
                placeholderTextColor="#a1a1aa"
                style={{ flex: 1, color: "#18181b", paddingVertical: 12, fontSize: 20 }}
              />
            ...
            <Pressable
              ...
              style={{ backgroundColor: colors.primary, borderRadius: 999, paddingVertical: 14, marginTop: 24 }}
            >
              <Text style={{ textAlign: "center", color: "#fff", fontSize: 19, fontWeight: "800" }}>{submitLabel}</Text>
            </Pressable>
            ...
            <View style={{ flexDirection: "row", gap: 8, marginTop: 12 }}>
              <Pressable
                ...
                style={{ flex: 1, borderRadius: 999, borderWidth: 1, borderColor: "#d4d4d8", paddingVertical: 8 }}
              >
                <Text style={{ textAlign: "center", color: "#3f3f46", fontSize: 12 }}>User</Text>
              </Pressable>
              <Pressable
                onPress={() => onQuickLogin("admin")}
                style={{ flex: 1, borderRadius: 999, borderWidth: 1, borderColor: "#d4d4d8", paddingVertical: 8 }}
              >
                <Text style={{ textAlign: "center", color: "#3f3f46", fontSize: 12 }}>Admin</Text>
              </Pressable>
              <Pressable
                onPress={() => onQuickLogin("guest")}
                style={{ flex: 1, borderRadius: 999, borderWidth: 1, borderColor: "#d4d4d8", paddingVertical: 8 }}
              >
            ...
            <Text style={{ color: "#71717a", marginTop: 10, fontSize: 11 }}>
              Test users: {users.map((user) => user.email).join(" | ")}
            </Text>
